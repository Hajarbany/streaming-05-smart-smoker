"""
    This script waits for the work messages contiously.
    In this script, we have three queues that are each being used to listen for messages separately about the temperatures of the Smoker, Food A, and Food B. 
...
SMOKER_ALERT_THRESHOLD = 15.0  # (in degrees F)
FOOD_STALL_THRESHOLD = 1.0     # (in degrees F)

def process_temperature(body, temperature_name, temperature_deque, alert_threshold):
    '''
    This function shows us the temperature that is being recorded. 
    ...
    '''
    try:
        # Split message sent from producer file into 2: 
